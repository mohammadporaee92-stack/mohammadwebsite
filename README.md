...
| ثبت‌نام/ورود با موبایل + کد پیامک (OTP) | ✅ حالت نمایشی |
...
- ورود ادمین: با همان شماره‌ای که در `ADMIN_PHONES` گذاشتی وارد شو (کد در حالت نمایشی روی صفحه نمایش داده می‌شود)، بعد برو به `/fa/admin`.
