...
export async function ProfilePhoto({ lang, size = "lg" }: { lang: Lang; size?: "lg" | "md" | "sm" }) {
  ...
  if (img) {
    ...
    return <img src={img} alt={lang === "fa" ? "محمد پرایی" : "Mohammad Poraee"} className={cx("object-cover rounded-3xl shadow-2xl shadow-blue-900/25 ring-4 ring-white", dims)} loading="lazy" />;
  }
  return (
